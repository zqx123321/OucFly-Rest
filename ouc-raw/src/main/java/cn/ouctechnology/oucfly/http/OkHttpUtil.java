...
public class OkHttpUtil {
    ...
    //创建cookie容器
    private final OkCookie okCookie = new OkCookie();
    ...
    private OkHttpClient client = new OkHttpClient.Builder().cookieJar(okCookie).retryOnConnectionFailure(true).build();
    ...
    public String get(String url, String refer) {
    ...
    public String get(String url, String refer, HttpParams params) {
        if (params != null)
     ...
     * @param params 请求参数
     */
    public String get(String url, String refer, String params) {
        //线程安全的request
    ...
    public String post(String url, String refer) {
     ...
     * @param params
     */
    public String post(String url, String refer, HttpParams params) {
        //线程安全的request
        Request.Builder builder = new Request.Builder().addHeader(HttpHeaders.USER_AGENT, USER_AGENT);
        if (params != null) {
     ...
     */
    public String postHttpClient(String url, String refer, String params) {
        // 全局请求设置
    ...
    private String doHttpRequest(Request request) {
        try {
